    ...
    <section className="py-20 bg-[#F8F8F8]">
      <div className="container max-w-6xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          {/* Video / Image Area */}
          <FadeUp>
            <div className="relative aspect-video bg-[#082135] rounded shadow-xl overflow-hidden group cursor-pointer border-4 border-white">
              {/* Image poster */}
              <img 
                src="/hero_video_poster.png" 
                alt="Proceso de fumigación" 
                className="w-full h-full object-cover opacity-80 group-hover:opacity-100 transition-opacity duration-500"
              />
              
              {/* Play button overlay */}
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="bg-[#e82536] text-white rounded-none p-4 shadow-lg group-hover:bg-[#c91e2d] transition-colors group-hover:scale-110 duration-300">
