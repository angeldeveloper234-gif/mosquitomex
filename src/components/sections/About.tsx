        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-[3rem] items-center">
          <FadeUp>
            <div className="relative group max-w-xl mx-auto lg:mx-0">
              ...
              <div className="absolute -inset-1.5 bg-[#ce1126] opacity-10 group-hover:opacity-20 transition-opacity duration-500 -z-10" />
              ...
              <div className="relative aspect-[3/2] w-full overflow-hidden border border-slate-200/80 dark:border-slate-800/80 shadow-xl bg-slate-50 dark:bg-slate-900">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#111111]/70 via-transparent to-transparent opacity-80 group-hover:opacity-60 transition-opacity duration-500" />
                ...
                <div className="absolute bottom-0 inset-x-0 p-[1.5rem] flex items-end justify-between">
                  ...
                  <span className="bg-[#ce1126] text-white text-[0.75rem] font-black uppercase tracking-wider px-[0.75rem] py-[0.25rem] select-none">
                    M.X.
                  </span>
                </div>
              </div>
          ...
          <FadeUp delay={0.2}>
            <div className="space-y-[1.5rem]">
              <h2 className="text-h2 font-black tracking-tighter uppercase leading-[1.15] text-[#111111] dark:text-slate-100">
                {t('about.titlePre')}<span className="text-[#ce1126]">{t('about.titleHighlight')}</span>
              </h2>
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-[1rem] pt-[1rem]">
                {benefitsList.map((benefit, i) => (
                  <li key={i} className="flex items-center gap-[0.75rem] text-[1rem] font-bold uppercase text-[#111111] dark:text-slate-200">
                    <CheckCircle2 className="text-[#ce1126] size-4 flex-shrink-0" />
                    <span>{benefit}</span>
                  </li>
                ))}
              </ul>
